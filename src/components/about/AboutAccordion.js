    ...
    const data = [
        {
            ...
            answer:
                <p className="aboutPara">Our Mission is to foster transparency, integrity, and accountability within our organization and the wider community. We are committed to providing a secure and confidential platform for individuals to report wrongdoing, ensuring their voices are heard, and taking decisive action against misconduct.</p>,
        ...
        },
        {
            question: "Values",
            answer:
                <p className="aboutPara"> Integrity - We uphold the highest standards of honesty and ethical conduct. We believe in doing what is right, even when it's difficult.</p>,
        ...
        },
        {
            ...
            answer:
                <p className="aboutPara">We prioritize the safety and well-being of whistleblowers. We provide safeguards to ensure their anonymity and protect them from retaliation.</p>,
