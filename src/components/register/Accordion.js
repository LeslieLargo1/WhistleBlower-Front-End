    ...
    return (
        <div className="accordion">
            <div className="question">
                ...
                {expand1 && <div>Internal whistleblowing is when someone makes a report within an organisation. Often companies implement internal whistleblowing channels for this purpose so that employees and other stakeholders can speak up if they become aware of misconduct. Employees can also report to their line manager.</div>}
            </div>
            <div className="question">
            ...
            <div className="question">
                ...
                {expand3 && <div>The company is obliged to confirm receipt of the report to the whistleblower within seven days. The whistleblower must be informed of any action taken within three months, the status of the internal investigation and its outcome.
                </div>}
            </div>
        </div>
